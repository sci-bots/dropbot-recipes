/* Fast digital input/output library
 *
 ...
 * Modified Copyright 2017 Christian Fobel
 *
 ...
 *
 *
 * This Arduino library is based on the `PJON/utils/digitalWriteFast.h` header
 * in the PJON (Padded Jittering Operative Network):
 *
 *     https://github.com/gioblu/PJON
 *
 * PJON and its brand are unregistered trademarks, property of Giovanni Blu
 * Mitolo <gioscarab@gmail.com>
 *
 * The original code has been modified by Christian Fobel <christian@fobel.net>
 * to bundle as an Arduino library installable as a Conda package.
 */

#ifndef __FAST_DIGITAL_H_INCLUDED__
  #define __FAST_DIGITAL_H_INCLUDED__
  ...
  #define BIT_WRITE(value, bit, bitvalue) (bitvalue ? BIT_SET(value, bit) : BIT_CLEAR(value, bit))
    ...
    #endif
  #endif
#endif  // #ifndef __FAST_DIGITAL_H_INCLUDED__
